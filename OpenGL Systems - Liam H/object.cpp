...
/****************************************************/
void object::render(float one, float two, float three, float size, bool moving)
{
	//leak test
	...
	{
//main-cam-----------------------------------------------------------------------------------------------------------------
		Cam.draw(program, 0.0f, false, one, two, three);
//main-cam-----------------------------------------------------------------------------------------------------------------
	}
	else
	{
		Cam.drawflat(program, 0.0f, false, one, two, three);
	}
